const AboutMe = () => {
    return (
      <section id="about" className="min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-100 to-gray-400 text-gray-800 dark:from-gray-800 dark:to-black dark:text-gray-300 py-16">
...
<p className="text-lg mb-6">
  One of my other projects, Hostel Bank, is designed for splitting and managing day-to-day transactions among hostel mates. It helps users keep track of shared expenses and simplifies financial management. I love exploring new technologies and am always excited about the future of tech.
</p>
